function [del_m_bar,A,B,C,D,E,F] = func_calc_del_m_bar(sub_1,sub_2,sub_3,sub_4,sub_5,sub_6,sub_7,sub_8,sub_9,sub_10,sub_11,sub_12,sub_13,sub_14,sub_15,sub_16,R1,R2,R3,R4,M_bar,M)
...
% del_e_nl parameters
A_den=inv(eye(M_bar+M,M_bar+M)-(del_e_nl_2*del_u_f_3));
