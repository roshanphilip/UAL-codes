...
main_file_path='C:\Users\rs7625\Desktop\UAL-codes-main\Unified 2D Codes';
% Enter location of results storage folder 
save_path='C:\Users\rs7625\Desktop\UAL-codes-main\Unified 2D Codes\Saved Files'; 

cd (main_file_path);

% Enter your model name
model_name = "SSNT_Coarse";
...
[SolverID,TangentID,RoutineID,ncoord,ndof,lc, ... 
            ...
            nnodes,coords,nelem,maxnodes,connect_nds,nelnodes,elident_vec,nfix,fixnodes,ArcLength_0,Constraint_type,delta_m_bar_0,Applied_Force_Load] = func_read_input_file(infile);  
...
if RoutineID == 1
    ...
    func_plotmesh2(coords,connect_nds,nelem,nodes_prop_mat(:,1),nodes_prop_mat(:,8),nodes_prop_mat(:,9),nelnodes,'interp',model_name,inc_success_counter,last_iteration,increment,loadfactor,solver_string,tangent_string,SolverID);
