function func_print_results(outfile, nprops,materialprops,ncoord,ndof,nnode,coords, ...
    nelem,maxnodes,connect,nelnodes,elident, nfix,fixnodes,ndload,dloads,dofs)
...
%
      ...
      npoints = func_numberofintegrationpoints;
      dNdx = zeros(n,ncoord);
...
%
       ...
       N = func_shapefunctions(xi);      
       dNdxi = func_shapefunctionderivs(xi);
%
...
%       stress = func_materialstress(ndof,ncoord,strain,materialprops);
% 
%       if (ncoord == 2) 
% 
