function [SolverID,TangentID,RoutineID,ncoord,ndof,lc, ... 
...
cellnumber  = cellnumber + 2;
RoutineID   = str2double(model_parameters_cellarray{1}{cellnumber});
% -------------------------------------------------------------------------
...
cellnumber                  = cellnumber + 2;
ArcLength_0                 = str2double(model_parameters_cellarray{1}{cellnumber});
cellnumber                  = cellnumber + 2;
Constraint_type             = str2double(model_parameters_cellarray{1}{cellnumber});
cellnumber                  = cellnumber + 2;
